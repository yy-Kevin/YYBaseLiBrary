package com.yy.yybaselibary.test;
...
public class LoadClass {
    ...
    public void setLoadClass() throws Exception {
        ...
        Class pClass3 = Class.forName("com.yy.yybaselibary.test.People");
        pClass1.newInstance();
        ...
        Log.e(TAG,"获取字段2 name = " + name.get(people));
        People people1 = new People();
        people1.setName("yuyao");
        String o = (String) name.get(people1);
        Log.e(TAG,"获取字段1 name = " + o);
        name.set(people1,"yuyao2");
        String o1 = (String) name.get(people1);
        Log.e(TAG,"获取字段2 name = " + o1);
...
//        constructor.setAccessible(true);
        ...
        Log.e(TAG,"获取字段 name = " + name.get(constructor1.newInstance("zs",2)));
